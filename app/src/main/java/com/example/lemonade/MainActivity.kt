    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                ...
                lemonImage!!.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.lemon_tree,null))
            }
            SQUEEZE -> {
                textAction.text = getString(R.string.lemon_squeeze)
                lemonImage!!.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.lemon_squeeze,null))
            }
            DRINK -> {
                textAction.text = getString(R.string.lemon_drink)
                lemonImage!!.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.lemon_drink,null))
            }
            RESTART -> {
                textAction.text = getString(R.string.lemon_empty_glass)
                lemonImage!!.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.lemon_restart,null))
            }
        }
